...
struct TreeVisitor_vtable * TreeVisitor_vtable_ptr;
void* get_TreeVisitor_vtable_();
struct TV_vtable TV_vtable_;
struct TV_vtable * TV_vtable_ptr;
void* get_TV_vtable_();
...
struct Visitor_vtable * Visitor_vtable_ptr;
void* get_Visitor_vtable_();
struct MyVisitor_vtable MyVisitor_vtable_;
struct MyVisitor_vtable * MyVisitor_vtable_ptr;
void* get_MyVisitor_vtable_();
...
int TV_Start(struct TV * this)
{
  ...
  root = ((struct Tree*)(Tiger_new (get_Tree_vtable_(), sizeof(struct Tree))));
  ...
  System_out_println (100000000);
  v = ((struct MyVisitor*)(Tiger_new (get_MyVisitor_vtable_(), sizeof(struct MyVisitor))));
  ...
  ntb = (x_17=root, x_17->vptr->Delete(x_17));
...
int Tree_Insert(struct Tree * this, int v_key)
{
  ...
  new_node = ((struct Tree*)(Tiger_new (get_Tree_vtable_(), sizeof(struct Tree))));
...
// vtable get methods
void* get_TreeVisitor_vtable_(){
  if(TreeVisitor_vtable_ptr== NULL){
    struct TreeVisitor_vtable temp = 
      {
      };
    memcpy(&TreeVisitor_vtable_, &temp, sizeof(temp));
    int equal = (int)memcmp(&TreeVisitor_vtable_, &temp, sizeof(temp));
    if(equal != 0){
      printf("Memory copy error: buffer polluted\n");
      exit(-2);
    }
    TreeVisitor_vtable_ptr = &TreeVisitor_vtable_;
  }
  return (void*)(TreeVisitor_vtable_ptr);
}

void* get_TV_vtable_(){
  if(TV_vtable_ptr== NULL){
    struct TV_vtable temp = 
      {
        TV_Start,
      };
    memcpy(&TV_vtable_, &temp, sizeof(temp));
    int equal = (int)memcmp(&TV_vtable_, &temp, sizeof(temp));
    if(equal != 0){
      printf("Memory copy error: buffer polluted\n");
      exit(-2);
    }
    TV_vtable_ptr = &TV_vtable_;
  }
  return (void*)(TV_vtable_ptr);
}
...
void* get_Visitor_vtable_(){
  if(Visitor_vtable_ptr== NULL){
    struct Visitor_vtable temp = 
      {
        Visitor_visit,
      };
    memcpy(&Visitor_vtable_, &temp, sizeof(temp));
    int equal = (int)memcmp(&Visitor_vtable_, &temp, sizeof(temp));
    if(equal != 0){
      printf("Memory copy error: buffer polluted\n");
      exit(-2);
    }
    Visitor_vtable_ptr = &Visitor_vtable_;
  }
  return (void*)(Visitor_vtable_ptr);
}

void* get_MyVisitor_vtable_(){
  if(MyVisitor_vtable_ptr== NULL){
    struct MyVisitor_vtable temp = 
      {
        MyVisitor_visit,
      };
    memcpy(&MyVisitor_vtable_, &temp, sizeof(temp));
    int equal = (int)memcmp(&MyVisitor_vtable_, &temp, sizeof(temp));
    if(equal != 0){
      printf("Memory copy error: buffer polluted\n");
      exit(-2);
    }
    MyVisitor_vtable_ptr = &MyVisitor_vtable_;
  }
  return (void*)(MyVisitor_vtable_ptr);
}
...
{
  struct TV * x_0;
  System_out_println ((x_0=((struct TV*)(Tiger_new (get_TV_vtable_(), sizeof(struct TV)))), x_0->vptr->Start(x_0)));
  return 0;
}
