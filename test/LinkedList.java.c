...
struct LinkedList_vtable * LinkedList_vtable_ptr;
void* get_LinkedList_vtable_();
struct Element_vtable Element_vtable_;
struct Element_vtable * Element_vtable_ptr;
void* get_Element_vtable_();
struct List_vtable List_vtable_;
struct List_vtable * List_vtable_ptr;
void* get_List_vtable_();
struct LL_vtable LL_vtable_;
struct LL_vtable * LL_vtable_ptr;
void* get_LL_vtable_();
...
struct List * List_Insert(struct List * this, struct Element * new_elem)
{
  ...
  aux03 = this;
  aux02 = ((struct List*)(Tiger_new (get_List_vtable_(), sizeof(struct List))));
...
int LL_Start(struct LL * this)
{
  ...
  last_elem = ((struct List*)(Tiger_new (get_List_vtable_(), sizeof(struct List))));
  aux01 = (x_23=last_elem, x_23->vptr->Init(x_23));
  head = last_elem;
  aux01 = (x_24=head, x_24->vptr->Init(x_24));
  aux01 = (x_25=head, x_25->vptr->Print(x_25));
  el01 = ((struct Element*)(Tiger_new (get_Element_vtable_(), sizeof(struct Element))));
  ...
  el03 = ((struct Element*)(Tiger_new (get_Element_vtable_(), sizeof(struct Element))));
...
// vtable get methods
void* get_LinkedList_vtable_(){
  if(LinkedList_vtable_ptr== NULL){
    struct LinkedList_vtable temp = 
      {
      };
    memcpy(&LinkedList_vtable_, &temp, sizeof(temp));
    int equal = (int)memcmp(&LinkedList_vtable_, &temp, sizeof(temp));
    if(equal != 0){
      printf("Memory copy error: buffer polluted\n");
      exit(-2);
    }
    LinkedList_vtable_ptr = &LinkedList_vtable_;
  }
  return (void*)(LinkedList_vtable_ptr);
}

void* get_Element_vtable_(){
  if(Element_vtable_ptr== NULL){
    struct Element_vtable temp = 
      {
        Element_Init,
        Element_GetAge,
        Element_GetSalary,
    ...
    memcpy(&Element_vtable_, &temp, sizeof(temp));
    int equal = (int)memcmp(&Element_vtable_, &temp, sizeof(temp));
    if(equal != 0){
      printf("Memory copy error: buffer polluted\n");
      exit(-2);
    }
    Element_vtable_ptr = &Element_vtable_;
  }
  return (void*)(Element_vtable_ptr);
}

void* get_List_vtable_(){
  if(List_vtable_ptr== NULL){
    struct List_vtable temp = 
      {
        List_Init,
        List_InitNew,
        List_Insert,
    ...
    memcpy(&List_vtable_, &temp, sizeof(temp));
    int equal = (int)memcmp(&List_vtable_, &temp, sizeof(temp));
    if(equal != 0){
      printf("Memory copy error: buffer polluted\n");
      exit(-2);
    }
    List_vtable_ptr = &List_vtable_;
  }
  return (void*)(List_vtable_ptr);
}

void* get_LL_vtable_(){
  if(LL_vtable_ptr== NULL){
    struct LL_vtable temp = 
      {
        LL_Start,
      };
    memcpy(&LL_vtable_, &temp, sizeof(temp));
    int equal = (int)memcmp(&LL_vtable_, &temp, sizeof(temp));
    if(equal != 0){
      printf("Memory copy error: buffer polluted\n");
      exit(-2);
    }
    LL_vtable_ptr = &LL_vtable_;
  }
  return (void*)(LL_vtable_ptr);
}
...
{
  struct LL * x_0;
  System_out_println ((x_0=((struct LL*)(Tiger_new (get_LL_vtable_(), sizeof(struct LL)))), x_0->vptr->Start(x_0)));
  return 0;
}
